...
//  Lesson_1
//
//  Created by Evgeny Kolesnik on 14.05.2020.
...
//протокол которые умеет обновлять данные в таблицах и коллекциях
fileprivate protocol Reloadable {
    func reloadRow( index: IndexPath )
}

class PhotoCache {
    //переменная указывающая время через которое мы должны обновить файл (60сек * 5 = 5мин)
    private let cacheLifeTime: TimeInterval = 60 * 5
    //изображения, которые будут храниться в оперативной памяти
    private var images = [String: UIImage]()
    
    //Папка для складирования КЭШа (static общая для всего приложения)
    private static let pathName: String = {
        ...
        //Проверяем, если такой папки ещё нету, то создаём
    ...
    //конструкторы для работы с таблицами и коллекциями
    ...
    //выборка названия изображения для сохранения его с таким же названием
    ...
    //функция использования картинки
...
//расширение класса для работы с таблицами и коллекциями
